...
const sectionHeadingClass =
  "text-2xl font-black text-[#1e293b] uppercase mb-6 tracking-tight border-b-2 border-gray-100 pb-2";
          ...
          {isUK ? (
            ...
            <>
              <section>
                ...
                <p className="leading-relaxed">
                  This Privacy Policy complies with UK GDPR and the Data
                  Protection Act 2018.
                </p>
              </section>
              <section>
                ...
                <p className="leading-relaxed mb-4">
                  The Company may collect identification details, contact
                  information, tax details, banking information, insurance
                  documents, background checks, GPS attendance data, performance
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  Data is processed for contract administration, compliance,
                  payment processing, regulatory requirements, and operational
                  management.
                </p>
              </section>
              <section>
                ...
                <p className="leading-relaxed">
                  Data is retained for statutory limitation periods (typically
                  6–7 years depending on jurisdiction).
                </p>
              </section>
              <section>
                <h2 className={sectionHeadingClass}>5. Security Measures</h2>
                <p className="leading-relaxed">
                  The Company implements encryption, role-based access controls,
                  secure servers, and breach response protocols.
                </p>
              </section>
              <section>
                <h2 className={sectionHeadingClass}>6. Contractor Rights</h2>
                <p className="leading-relaxed">
                  Contractors have rights under the UK GDPR including access,
                  rectification, erasure, restriction, data portability, and the
            ...
            <>
              ...
              <section>
                <h2 className={sectionHeadingClass}>6. Contractor Rights</h2>
                <p className="leading-relaxed">
                  Contractors may request access, correction, or lawful erasure
                  of personal data subject to legal limitations.
                </p>
              </section>
              <section className="bg-slate-50 border border-gray-400 p-8 md:p-12 rounded-sm text-center">
                <h2 className="text-2xl font-black text-[#1e293b] uppercase mb-6 tracking-widest text-center">
            ...
            <>
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  Personal data is retained for statutory limitation periods
                  (typically 6–7 years), or longer where required by law.
                </p>
              </section>
              <section>
              ...
              <section>
                ...
                <p className="leading-relaxed mb-2">
                  Subject to legal limitations, Contractors may:
                </p>
                <ul className="list-disc pl-8 space-y-2 leading-relaxed">
            ...
            <>
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  This Privacy Policy complies with the UK General Data
                  Protection Regulation (UK GDPR) and the Data Protection Act
                  2018. By using our services, you consent to the data practices
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <ul className="list-disc pl-8 space-y-3 leading-relaxed">
                      ...
                      <li>
                        <strong>Communication Data:</strong> Emails, messages,
                        phone calls, and other communications with us
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-8 space-y-3 leading-relaxed">
                      ...
                      <li>
                        Social media platforms (if you log in using social
                        media)
                      </li>
                      <li>Marketing partners (with your consent)</li>
                      <li>
                        Public databases and credit reference agencies (for
                        fraud prevention)
                      </li>
                    </ul>
                  </div>
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <ul className="list-disc pl-8 space-y-3">
                      <li>
                        ...
                        cleaning services you have requested
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        and optional data processing (you can withdraw consent
                        at any time)
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="list-disc pl-8 space-y-3">
                      ...
                      <li>
                        To communicate with you about bookings, changes, and
                        updates
                      </li>
              ...
              <section>
                ...
                <ul className="list-disc pl-8 space-y-4 mb-8">
                  <li>
                    <strong>Our Cleaners:</strong> We share necessary
                    information (name, address, contact details, service
                    requirements) with assigned cleaners to perform services.
                  </li>
                  <li>
                    <strong>Payment Processors:</strong> We use third-party
                    payment processors (e.g., Stripe, PayPal) to handle
                    transactions securely. They have access to payment
                    information only.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Legal Authorities:</strong> We may disclose
                    information if required by law, court order, or to protect
                    our legal rights.
                  </li>
                  <li>
                    <strong>Business Transfers:</strong> If we merge with or are
                    acquired by another company, your data may be transferred to
                    the new owner.
                  </li>
                </ul>
              ...
              <section>
                ...
                <ul className="list-disc pl-8 space-y-3">
                  <li>
                    ...
                    is active and for 6 years after account closure (for legal
                    and tax purposes)
                  </li>
                  <li>
                    <strong>Booking and Payment Data:</strong> Retained for 6
                    years after the last transaction (for accounting and legal
                    compliance)
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul className="list-disc pl-8 space-y-4 font-medium leading-relaxed">
                  ...
                  <li>
                    ...
                    processing based on legitimate interests or for marketing
                    purposes.
                  </li>
                  <li>
                    <strong>Right to Withdraw Consent:</strong> You can withdraw
                    consent for data processing at any time (does not affect
                    prior processing).
                  </li>
                  <li>
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="leading-relaxed">
                      ...
                      you visit our website. They help us improve your
                      experience and provide certain features.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-black text-slate-800 text-sm uppercase mb-3 tracking-widest">
                    ...
                    <ul className="list-disc pl-8 space-y-3">
                      <li>
                        ...
                        website to function (e.g., session management,
                        security). Cannot be disabled.
                      </li>
                      <li>
                        <strong>Performance Cookies:</strong> Help us understand
                        how visitors use our website (e.g., Google Analytics).
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  ...
                  payment processors, social media). We are not responsible for
                  the privacy practices of these websites. We encourage you to
                  read their privacy policies before providing any personal
                  information.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  ...
                  we will delete it promptly. If you believe we have collected
              ...
              <section>
                ...
                <p className="mb-6 leading-relaxed">
                  ...
                  the United Kingdom. If we transfer data outside the UK or
                  European Economic Area (EEA), we will ensure appropriate
              ...
              <section>
                ...
                <p className="leading-relaxed">
                  ...
                  will be posted on our website with an updated "Last Updated"
                  date. We encourage you to review this policy periodically. If
                  we make significant changes, we will notify you by email or
